...
c.text+"</p>");break;case "copyright":b.push('<p class="copyright">'+c.text+"</p>");break;case "scene_heading":a.push("<h3>"+c.text+"</h3>");break;case "transition":a.push("<h2>"+c.text+"</h2>");break;case "dialogue_begin":a.push('<div class="dialogue'+(c.dual?"dual-dialogue":"")+'">');break;case "character":a.push("<h4>"+c.text+"</h4>");break;case "parenthetical":a.push('<p class="parenthetical">'+c.text+"</p>");break;case "dialogue":a.push("<p>"+c.text+"</p>");break;case "dialogue_end":a.push("</div> ");
